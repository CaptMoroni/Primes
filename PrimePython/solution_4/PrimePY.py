...
class prime_sieve(object):
    ...
    def __init__(this, limit):
        ...
        this.rawbits = np.zeros((limit+1)/2, dtype=np.int64)
        this.sieveSize = 0    # Upper limit, highest prime we'll consider

        this.primeCounts = { 10 : 4,                 # Historical data for validating our results - the number of primes
